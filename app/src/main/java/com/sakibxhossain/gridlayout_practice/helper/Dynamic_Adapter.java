...
public class Dynamic_Adapter extends BaseAdapter {
    ...
    Dynamic_ClickListener dynamic_clickListener;

    public Dynamic_Adapter(Context context, String[] sorting_algo_title, String[] sorting_algo_difficulty, Dynamic_ClickListener dynamic_clickListener) {
        this.context = context;
        this.sorting_algo_title = sorting_algo_title;
        this.sorting_algo_difficulty = sorting_algo_difficulty;
        this.dynamic_clickListener = dynamic_clickListener;
    }
    ...
    public View getView(int position, View view, ViewGroup viewGroup) {
        ...
        sorting_algo_cardView_container.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                dynamic_clickListener.onItemClicked(position);
            }
        });
