...
public class Greedy_Adapter extends BaseAdapter {

    Context context;
    String[] sorting_algo_title;
    String[] sorting_algo_difficulty;
    Greedy_ClickListener greedy_clickListener;

    public Greedy_Adapter(Context context, String[] sorting_algo_title, String[] sorting_algo_difficulty, Greedy_ClickListener greedy_clickListener) {
        this.context = context;
        this.sorting_algo_title = sorting_algo_title;
        this.sorting_algo_difficulty = sorting_algo_difficulty;
        this.greedy_clickListener = greedy_clickListener;
    }
    ...
    public View getView(int position, View view, ViewGroup viewGroup) {
        ...
        sorting_algo_cardView_container.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                greedy_clickListener.onItemClicked(position);
            }
        });
