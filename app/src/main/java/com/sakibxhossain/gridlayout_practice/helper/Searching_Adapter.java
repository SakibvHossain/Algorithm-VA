...
public class Searching_Adapter extends BaseAdapter {
    ...
    Searching_ClickListener searching_clickListener;

    public Searching_Adapter(Context context, String[] sorting_algo_title, String[] sorting_algo_difficulty, Searching_ClickListener searching_clickListener) {
        this.context = context;
        this.sorting_algo_title = sorting_algo_title;
        this.sorting_algo_difficulty = sorting_algo_difficulty;
        this.searching_clickListener = searching_clickListener;
    }
    ...
    public View getView(int position, View view, ViewGroup viewGroup) {
        ...
        sorting_algo_cardView_container.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                searching_clickListener.onItemClicked(position);
            }
        });
