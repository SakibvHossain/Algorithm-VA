...
public class Sorting_Adapter extends BaseAdapter {

    Context context;
    String[] sorting_algo_title;
    String[] sorting_algo_difficulty;
    Sorting_ClickListener listener;

    public Sorting_Adapter(Context context, String[] sorting_algo_title, String[] sorting_algo_difficulty, Sorting_ClickListener listener) {
