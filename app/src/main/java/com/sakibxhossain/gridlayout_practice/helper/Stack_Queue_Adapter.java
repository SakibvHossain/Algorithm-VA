...
public class Stack_Queue_Adapter extends BaseAdapter {

    Context context;
    String[] sorting_algo_title;
    String[] sorting_algo_difficulty;
    Stack_Queue_ClickListener stack_queue_clickListener;

    public Stack_Queue_Adapter(Context context, String[] sorting_algo_title, String[] sorting_algo_difficulty, Stack_Queue_ClickListener stack_queue_clickListener) {
        this.context = context;
        this.sorting_algo_title = sorting_algo_title;
        this.sorting_algo_difficulty = sorting_algo_difficulty;
        this.stack_queue_clickListener = stack_queue_clickListener;
    }
    ...
    public View getView(int position, View view, ViewGroup viewGroup) {
        ...
        sorting_algo_cardView_container.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                stack_queue_clickListener.onItemClicked(position);
            }
        });
