...
public class Strings_Algo_Adapter extends BaseAdapter {
    Context context;
    String[] sorting_algo_title;
    String[] sorting_algo_difficulty;
    Strings_Algo_ClickListener strings_algo_clickListener;

    public Strings_Algo_Adapter(Context context, String[] sorting_algo_title, String[] sorting_algo_difficulty, Strings_Algo_ClickListener strings_algo_clickListener) {
        this.context = context;
        this.sorting_algo_title = sorting_algo_title;
        this.sorting_algo_difficulty = sorting_algo_difficulty;
        this.strings_algo_clickListener = strings_algo_clickListener;
    }
    ...
    public View getView(int position, View view, ViewGroup viewGroup) {
        ...
        sorting_algo_cardView_container.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                strings_algo_clickListener.onItemClicked(position);
            }
        });
